...
const variants = {
  ...
  secondary: 'bg-secondary text-white hover:bg-slate-800 shadow-md',
...
export const Button = React.forwardRef(({ 
  ...
  return (
    <motion.button
      ...
      className={cn(
        'inline-flex items-center justify-center rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-primary/50 disabled:opacity-60 disabled:cursor-not-allowed',
        variants[variant],
        sizes[size],
        className
      )}
